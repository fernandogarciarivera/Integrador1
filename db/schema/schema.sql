...
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `localEmpresa`
ADD FOREIGN KEY(`idLocalEmpresa`, `idEmpresa`) REFERENCES `colaborador`(`idLocalEmpresa`, `idEmpresa`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `colaborador`
ADD FOREIGN KEY(`idColaborador`) REFERENCES `users`(`idColaborador`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `estadoAviso`
ADD FOREIGN KEY(`idEstadoAviso`) REFERENCES `estadoAvisoFormulario`(`idEstadoAviso`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `formularioApp`
ADD FOREIGN KEY(`idFormularioApp`) REFERENCES `estadoAvisoFormulario`(`idFormularioAcceso`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `localEmpresa`
ADD FOREIGN KEY(`idLocalEmpresa`, `idEmpresa`) REFERENCES `pedidoLocal`(`idLocalEmpresa`, `idEmpresa`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `pedidoLocal`
ADD FOREIGN KEY(`idPedidoLocal`) REFERENCES `metricaPedido`(`idPedidoLocal`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `estadoAviso`
ADD FOREIGN KEY(`idEstadoAviso`) REFERENCES `metricaPedido`(`idEstadoAviso`)
ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE `formularioApp`
ADD FOREIGN KEY(`idFormularioApp`) REFERENCES `metricaPedido`(`idEstadoAviso`)
ON UPDATE NO ACTION ON DELETE NO ACTION;